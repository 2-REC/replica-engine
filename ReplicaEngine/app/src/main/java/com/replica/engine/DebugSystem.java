...
public final class DebugSystem extends BaseObject {
	...
	public DebugSystem(Context context, TextureLibrary library) {
		super();
		if (library != null) {
			mRedBoxTexture = library.allocateTexture(UtilsResources.getResourceIdByName(context, "drawable", "debug_box_red"));
			mBlueBoxTexture = library.allocateTexture(UtilsResources.getResourceIdByName(context, "drawable", "debug_box_blue"));
			mOutlineBoxTexture = library.allocateTexture(UtilsResources.getResourceIdByName(context, "drawable", "debug_box_outline"));
			mRedCircleTexture = library.allocateTexture(UtilsResources.getResourceIdByName(context, "drawable", "debug_circle_red"));
			mBlueCircleTexture = library.allocateTexture(UtilsResources.getResourceIdByName(context, "drawable", "debug_circle_blue"));
			mOutlineCircleTexture = library.allocateTexture(UtilsResources.getResourceIdByName(context, "drawable", "debug_circle_outline"));
