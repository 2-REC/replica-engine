...
public class LauncherComponent extends GameComponent {
    ...
    private void fire(GameObject object, GameObject parentObject, float mAngle) {
        ...
        if (mLaunchEffect != 0) {
        	...
        	if (factory != null && manager != null) {
        		...
        		GameObject effect = factory.spawnFromOrdinal(mLaunchEffect, 
    ...
    public void setLaunchEffect(int effectTypeOrdinal, float offsetX, float offsetY) {
    	mLaunchEffect = effectTypeOrdinal;
