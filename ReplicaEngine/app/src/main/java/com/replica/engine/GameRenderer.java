...
import com.replica.engine.RenderSystem.RenderElement;
...
*/
    ...
    public void loadTextures(GL10 gl, TextureLibrary library) {
        if (gl != null) {
            ...
            DebugLog.d("GameRenderer", "Textures Loaded.");
        }
    }
    ...
    public void flushTextures(GL10 gl, TextureLibrary library) {
        if (gl != null) {
            ...
            DebugLog.d("GameRenderer", "Textures Unloaded.");
        }
    }
    ...
    public void loadBuffers(GL10 gl, BufferLibrary library) {
        if (gl != null) {
            ...
            DebugLog.d("GameRenderer", "Buffers Created.");
        }
    }
    ...
    public void flushBuffers(GL10 gl, BufferLibrary library) {
        if (gl != null) {
            ...
            DebugLog.d("GameRenderer", "Buffers Released.");
        }
    }
...
////////
// !!!! TODO : all this could be removed !!!!
// => or set into a "debug case"
...
////////
    ...
    public void onSurfaceChanged(GL10 gl, int w, int h) {
        DebugLog.d("GameRenderer", "Surface Size Change: " + w + ", " + h);
