...
public class PreferenceConstants {
    ...
    public static final String PREFERENCE_AUDIO_DISABLE = "disableAudio";
...
//    public static final String PREFERENCE_FLIP = "flipControls";
    ...
    public static final String PREFERENCE_MAIN_STATE = "mainState";
    public static final String PREFERENCE_GAME_STATE = "gameState";
    public static final String PREFERENCE_END_STATE = "endState";
//////// CONTINUE 20140411 - MID
    public static final String PREFERENCE_CONTINUE = "continue";
